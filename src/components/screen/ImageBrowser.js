...
class ImageBrowser extends React.Component {
  ...
  state = {
    ...
    loading: true,
    page: 1,
    key: '37337415ef622bf09d999745c75e165cc3be7f48ce9975aa48968fa5009e6676',
  }
  ...
  fetchPhotos = () => {
    ...
    fetch(`https://api.unsplash.com/photos/?page=${this.state.page}&per_page=30&client_id=${this.state.key}`)
      .then(res => res.json())
      .then(images => {

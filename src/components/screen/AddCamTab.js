...
export default class AddCamTab extends Component {
  ...
  fetchPhotos = () => {
    ...
    fetch('https://api.unsplash.com/photos/?page=1&per_page=30&client_id=37337415ef622bf09d999745c75e165cc3be7f48ce9975aa48968fa5009e6676')
      .then(res => res.json())
      .then(images => {

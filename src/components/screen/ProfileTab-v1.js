...
export default class ProfileTab extends React.Component {
    ...
    static navigationOptions = {
        tabBarIcon: ({ tintColor }) => (
            <TouchableOpacity>
                <Image style={{ width: 30, height: 30, resizeMode: 'center' }} source={require('../assets/home/icon_account.png')}/>
            </TouchableOpacity>
        )
    }
    ...
    componentDidMount() {
        return fetch('http://www.json-generator.com/api/json/get/cfOMufoqPS?indent=2')
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#fafafa' }}>
                ...
                <View style={{ flex: 13, backgroundColor: '#F2F2F2' }}>
                    <ScrollView contentContainerStyle={{ paddingVertical: 100, paddingTop: 0 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            renderItem={({item}) => 
                                <View style={{ flex: 6, flexDirection: 'column', backgroundColor: '#fafafa', marginBottom: 5 }}>
                                    ...
                                    <View style={{ flex: 1, paddingTop: 5, paddingBottom: 3, paddingLeft: 15 }}>
                                        <Text style={{ fontSize: 12, color: 'black' }}>{item.age} Likes</Text>
                                    </View>
